...
def get_config():
    ...
    # PI specs
    pi_params = lambda tau_abs, h_0, n: {
        "n_ode_steps": n,
        "ki": 0.3,
        "kp": 0.1,
        "tau_a": tau_abs,
    ...
    add_spec("pi", "no_rtol", 49, **pi_params(8.5, 45, 5))
    add_spec("pi", "no_rtol", 75, **pi_params(5.3, 40, 7))
    add_spec("pi", "no_rtol", 99, **pi_params(4.5, 35, 10))
